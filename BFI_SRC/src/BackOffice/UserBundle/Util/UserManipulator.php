...
namespace BackOffice\UserBundle\Util;
...
class UserManipulator
{
     ...
     */
    public function create($name, $firstname, $codeuser, $password, $email, $active, $superadmin)
    {
        $user = $this->userManager->createUser();
        $username = strtolower(substr($firstname, 0, 1).".".$name);
