 ...
 *
 * @ORM\Table(indexes={
 *      @ORM\Index(name="idx_niveau", columns={"niveau"}),
 *      @ORM\Index(name="idx_module", columns={"module"}),
 *      @ORM\Index(name="idx_datetime", columns={"datetime"})
 * })
 * @ORM\Entity(repositoryClass="BackOffice\MonitoringBundle\Entity\LogRepository")
 */
class Log
{
    const NIVEAU_INFO = 0;
